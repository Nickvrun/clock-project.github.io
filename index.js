function digitalClock(){
    ...
    function settime(){
        ...
        if(wakeuptime == hours){
            changeImage[0].style.backgroundImage='url("./pic/wakeup_image.svg")';
            changeText[0].innerText="WAKE UP !!";
        }
    
        if(lunchtime == hours ) {
            changeImage[0].style.backgroundImage='url("./pic/lunch_image.svg")';
            changeText[0].innerText="LET'S HAVE SOME LUNCH !!";
        }
    
         if( naptime == hours ) {
            changeImage[0].style.backgroundImage='url("./pic/goodnight_image.svg")';
